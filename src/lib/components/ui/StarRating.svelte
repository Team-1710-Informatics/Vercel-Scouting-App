...
<div class="flex flex-col">
    <div
        class="grid"
        style="grid-template-columns: repeat({stars}, minmax(0, 1fr));"
    >
...
<style>
    .star {
        filter: brightness(0) saturate(100%) invert(92%) sepia(61%)
            saturate(420%) hue-rotate(155deg) brightness(105%) contrast(104%);
    }
</style>
