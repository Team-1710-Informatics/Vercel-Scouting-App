...
>
    ...
    <div class="grid grid-cols-1">
        {#if data?.success}
            <p transition:slide class="success" style="width:200px">
                {data.success}
            </p>
        {/if}
        {#if data?.alert}
            <p transition:slide class="alert" style="width:200px">
                {data.alert}
            </p>
        {/if}
        {#if data?.error}
            <p transition:slide class="error" style="width:200px">
                {data.error}
            </p>
        {/if}
    </div>
    ...
    {#each inputs as field}
        <label style="grid-column: span {field.cols} / span {field.cols};">
            ...
            <input
                style="width:{width(field.cols)}px"
                class="mb-1"
    ...
    <center class="col-span-6 bg-green mt-2"
