<script>
    ...
    export async function teamPrediction() {
        teams = allianceSelection.getPickedAlliances();
...
<div class="w-full basis-1/2">
    <div class="flex flex-row mb-4 options rounded-lg border-0 border-black">
    ...
    <div
        class="draggable-container border-0 border-black rounded-lg overflow-hidden relative"
        style="height: calc(100% - 1rem - {controlPanelHeight}px); "
    >
        {#if data}
            <div
...
<style lang="scss">
    ...
    .blue-glow:hover {
        text-shadow:
            0 0 5px rgba(255, 255, 255, 0.75),
            0 0 10px rgba(0, 0, 255, 0.75),
            0 0 20px rgba(0, 0, 255, 0.75);
        color: rgba(255, 255, 255, 0.4);
    }
    .blue-win {
        text-shadow:
