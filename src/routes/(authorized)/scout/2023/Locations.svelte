...
<div class="flex flex-row w-full bg-teal-900 rounded-lg">
    <button class="p-0 px-2 bg-gradient-to-br from-teal-600 to-teal-300 text-teal-800 font-bold border-teal-800" on:click={()=>{inc(-1)}}>{"<"}</button>
    ...
    <button class="p-0 px-2 bg-gradient-to-bl from-teal-600 to-teal-300 text-teal-800 font-bold border-teal-800" on:click={()=>{inc(1)}}>{">"}</button>
</div>