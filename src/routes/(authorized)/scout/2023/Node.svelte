...
<div
    class="node text-center border-x-4 border-transparent relative"
...
{/if} -->
    {#if type != 'h'}
        <button
            ...
            on:click={() => {
                logPlacement(type == 'c' ? 'cube' : 'cone')
            }}
            class="p-0 bg-none border-none w-full h-full grid justify-items-center items-center"
        >
    ...
    {:else}
        <div class="w-full h-full grid grid-cols-2 relative">
            ...
            <button
                ...
                class="p-0 bg-none border-none absolute self-end"
            ...
            <button
                ...
                class="p-0 bg-none border-none absolute justify-self-end"
                style="width:{size / 2}px;"
            >
                <img
                    class="w-full"
...
<style>
    .purple {
        filter: brightness(0) saturate(100%) invert(23%) sepia(68%)
            saturate(1410%) hue-rotate(227deg) brightness(86%) contrast(93%);
    }

    .yellow {
        filter: brightness(0) saturate(100%) invert(67%) sepia(87%)
            saturate(681%) hue-rotate(349deg) brightness(103%) contrast(98%);
    }

    .green {
        filter: brightness(0) saturate(100%) invert(67%) sepia(53%)
            saturate(7278%) hue-rotate(93deg) brightness(110%) contrast(119%);
    }
