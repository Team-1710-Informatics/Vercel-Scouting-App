...
export async function GET({ params }){
    ...
    return json({value:Math.trunc((aas)+(rp*30)+(win*100))*2, team:params.team})
}
...
function rankingPoints(team,match){
    ...
    else if(match.score_breakdown[alliance].links.length === 4 && match.score_breakdown[alliance].coopertitionCriteriaMet)
        out += 1;
