    ...
    <div class="font-serif font-black">
        <div class="box">
            <center>
                <label>
                    <button
                        class="rounded-none border-b-4 border-black hover:border-gray-400 bg-gradient-to-b from-sky-50 to-sky-200"
                        on:click={() => {
                            team = inputTeam
                        }}>Search Stock:</button
                    >
                    ...
                    {#if t.value != undefined}
                        <div transition:slide>
                            ...
                            >
                                ...
                                <div class="grid grid-cols-2">
                                    <div
                                        class="text-2xl col-span-2 justify-self-start"
                                    >
                                        {Math.trunc(
                                            $credits - stocks * t.value
                                        )} cr.
                                    </div>
                                    <div
                                        class="justify-self-start self-end"
                                        class:text-red-500={num() + stocks > 5}
                                    >
                                        {num() + stocks}<span class="opacity-50"
                                            >/5</span
                                        >
                                    </div>
                                    <button
                                        disabled={loading ||
                                            ...
                                            num() + stocks > 5}
                                        class="rounded-none border-black bg-gradient-to-b from-green-200 to-emerald-400 w-fit justify-self-end"
                                        >{stocks * t.value} cr.</button
                                    >
                                </div>
                            </form>
                        </div>
    ...
    <div class="box font-serif font-black">
        <div class="grid grid-cols-5">
            ...
            <div class="justify-self-center">
                {#key data.portfolio}{num()}<span class="opacity-50">/5</span
                    >{/key}
            </div>
                    ...
                    <tr animate:flip>
                        {#if data.portfolio.portfolio[team] > 0}
                            ...
                            {:then v}
                                <td
                                    >{v.value *
                                        data.portfolio.portfolio[team]}</td
                                >
                                <td class="p-0">
                                        ...
                                        >
                                            ...
                                            <button
                                                disabled={sell <= 0 ||
                                                    ...
                                                    loading}
                                                class="w-full h-full rounded-none bg-gradient-to-b from-red-100 to-rose-400 border-black text-xs"
                                                >{sell ?? 0} for<br />{sell *
                                                    v.value} cr.</button
                                            >
                                        </form>
