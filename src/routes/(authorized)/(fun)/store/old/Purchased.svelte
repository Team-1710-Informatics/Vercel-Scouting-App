...
<div transition:slide class="rounded-lg w-80 merch" style={item?.color?`--color:${item.color}`:`--color:255, 255, 255`}>
    <p>{item.name}</p>
...
<style>
    .merch {
        ...
        background-image: radial-gradient(ellipse at bottom, rgba(var(--color),0.25) 0%, rgba(255,255,255,0) 70%);
