...
export const actions = {
    default: async function({request,locals}){
        ...
        const items = ["event","team","intakeCube","intakeCone","shelfStation","chuteStation","floorStation","floor","placeHigh","placeMid","placeLow","mainStrategy","autoStrategy","averageScore","chargeStationMain","chargeStationAuto","drivetrain","piecePreferance","framePerimeter","weight","thoughts","otherScouts"]
