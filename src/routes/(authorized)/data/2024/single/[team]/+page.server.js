...
export async function load({ params, locals }){
    const data = JSON.parse(JSON.stringify(await ScoutData.find({team:params.team})));
    const pitData = JSON.parse(JSON.stringify(await pitdata2024.findOne({team:params.team})));
